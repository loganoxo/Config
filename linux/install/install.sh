...
# 一、使用 github
# 1.用wget(debian默认安装)
# wget -q -O- --header="Cache-Control: no-cache" "https://raw.githubusercontent.com/loganoxo/Config/master/linux/install/install.sh?$(date +%s)" | bash -s -- "${ZSH_VERSION:-nozsh}" "$USER" 0
