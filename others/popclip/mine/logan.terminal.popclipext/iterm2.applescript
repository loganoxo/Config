...
on run argv
	...
	if "{popclip option new_window}" is "1" then
	...
	set selection_logan to "{popclip text}"
	send_text_without_execute(the_current_window, selection_logan)
	delay 0.1
	activate_app()
end run
