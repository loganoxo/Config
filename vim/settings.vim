...
"                                  主要配置
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"----------------- 解决vi/vim退格键和箭头键不能用的问题 -----------------

" 用来关闭 vi/vim 的兼容模式;解决方向键和其他现代编辑功能的问题;在兼容模式下,vi/vim 的功能非常受限,某些按键操作(例如方向键和退格键)可能无法正常工作;
" 关闭兼容模式后,vim 会启用更多现代功能,包括更好的键盘支持,使方向键和退格键可以正常使用
set nocompatible

" 设置退格键可用，正常处理 indent(缩进), eol(允许删除到行头后,继续向上一行删除), start(可以一直删除到行头)
set backspace=eol,start,indent
" set backspace=2 是 Vim 的一种更早期的写法,也能使用
" 在早期的 Vim 版本中,backspace 选项使用数字值(0 1 2)进行配置;2 是最宽松的配置，相当于 indent,eol,start
